...
public class MyAdapterJuvenile extends RecyclerView.Adapter<MyAdapterJuvenile.MyViewHolder> {
    private ShowCasesJ activity;
    private List<ModelJ> mList;
    //private FirebaseFirestore db = FirebaseFirestore.getInstance();

    public MyAdapterJuvenile(ShowCasesJ activity , List<ModelJ> mList){
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView name,category,bailable,city,date,desc,age, id;
        public MyViewHolder(@NonNull View itemView) {
            ...
            id = itemView.findViewById(R.id.id_j);
