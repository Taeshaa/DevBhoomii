    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(introPage.this, LoginActivity.class);
                startActivity(i);
            }
        });
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!pwd.equals(cnfPwd)) {
                    Toast.makeText(introPage.this, "Please check both having same password..", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(userName) && TextUtils.isEmpty(pwd) && TextUtils.isEmpty(cnfPwd)) {

                    // checking if the text fields are empty or not.
                    Toast.makeText(introPage.this, "Please enter your credentials..", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    mAuth.createUserWithEmailAndPassword(userName, pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(introPage.this, "User Registered..", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(introPage.this, LoginActivity.class);
                                startActivity(i);
                                finish();
                            } else {
                                ...
                                loadingPB.setVisibility(View.GONE);
                                Toast.makeText(introPage.this, "Fail to register user..", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
